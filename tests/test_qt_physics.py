...
# -----------------------------------------------------------------------------
# RigidBodySimulator tests — the mouse-joint model that replaces
# PendulumSimulator. Validates the soft-constraint solver, off-COM
# parallel-axis behavior, release-coast (no double-counted impulse),
# and home-spring settle.
# -----------------------------------------------------------------------------
