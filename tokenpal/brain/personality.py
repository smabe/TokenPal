...
class PersonalityEngine:
    ...
    def _tool_use_rule(names: list[str]) -> str:
        ...
        return (
            ...
            "answer, or a clarifying question. For 'best X', 'which X "
            "should I buy', or any comparison question, call `research`; "
            "do NOT chain multiple `search_web` calls. For casual chat, "
            "just answer.\n"
