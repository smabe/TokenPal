    ...
    def build_conversation_system_message(self) -> str:
        ...
        if self.is_finetuned:
            return (
                ...
                "6. You have tools. If the user asks something you'd need to look up "
                "(current events, calculations, git history, system stats), call a "
                "tool — don't guess. For casual chat or questions you're confident "
                "about, just answer.\n\n"
                f"{self._mood_line()}\n\n"
